...
static bool write_utf16(charset_spec const *charset, long int input_chr,
                        charset_state *state,
                        void (*emit)(void *ctx, long int output),
                        void *emitctx)
{
...
static const struct utf16 utf16_bigendian = { 0x20000, true };
static const struct utf16 utf16_littleendian = { 0x10000, true };
static const struct utf16 utf16_bigendian_no_bom = { 0x20000, false };
static const struct utf16 utf16_littleendian_no_bom = { 0x10000, false };
static const struct utf16 utf16_variable_endianness = { 0x30000, true };
...
const charset_spec charset_CS_UTF16BE_NO_BOM = {
    CS_UTF16BE_NO_BOM, read_utf16, write_utf16, &utf16_bigendian_no_bom
};
const charset_spec charset_CS_UTF16LE_NO_BOM = {
    CS_UTF16LE_NO_BOM, read_utf16, write_utf16, &utf16_littleendian_no_bom
};
...
ENUM_CHARSET(CS_UTF16BE_NO_BOM)
ENUM_CHARSET(CS_UTF16LE_NO_BOM)
