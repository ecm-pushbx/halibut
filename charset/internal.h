...
struct charset_spec {
     ...
     * encoded text.
     */
    bool (*write)(charset_spec const *charset, long int input_chr,
                  charset_state *state,
                  void (*emit)(void *ctx, long int output), void *emitctx);
    void const *data;
};
...
void read_sbcs(charset_spec const *charset, long int input_chr,
	       charset_state *state,
	       void (*emit)(void *ctx, long int output), void *emitctx);
bool write_sbcs(charset_spec const *charset, long int input_chr,
                charset_state *state,
                void (*emit)(void *ctx, long int output), void *emitctx);
...
bool unicode_to_big5(long int unicode, int *r, int *c);
...
bool unicode_to_cp949(long int unicode, int *r, int *c);
long int ksx1001_to_unicode(int r, int c);
bool unicode_to_ksx1001(long int unicode, int *r, int *c);
