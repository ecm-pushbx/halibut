...
static bool unicode_to_emacs_big5(long int, int *, int *, int *);
...
static bool unicode_to_null_dbcs(long int, int *, int *);

typedef bool (*to_dbcs_t)(long int, int *, int *);
typedef bool (*to_dbcs_planar_t)(long int, int *, int *, int *);
...
static bool unicode_to_null_dbcs(long int unicode, int *r, int *c)
{
    UNUSEDARG(unicode);
    UNUSEDARG(r);
    UNUSEDARG(c);
    return false;                     /* failed to convert anything */
}
...
static bool unicode_to_emacs_big5(long int unicode, int *p, int *r, int *c)
{
    int rr, cc, s;
...
static void oselect(charset_state *state, int i, bool right,
		    void (*emit)(void *ctx, long int output),
		    void *emitctx)
{
 ...
 * carefully.
 */
static bool write_iso2022(charset_spec const *charset, long int input_chr,
                          charset_state *state,
                          void (*emit)(void *ctx, long int output),
                          void *emitctx)
{
